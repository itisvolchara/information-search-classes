...
html_directory = pathlib.Path(__file__).parent.parent / "task1-crawler" / "downloaded_pages"
tokens_output_directory = pathlib.Path(__file__).parent / "processed_tokens" / "tokens"
lemmatized_output_directory = pathlib.Path(__file__).parent / "processed_tokens" / "lemmatized"
